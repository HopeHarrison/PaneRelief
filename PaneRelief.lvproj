	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Low-Level VI Manipulation" Type="Folder">
			<Item Name="Type ID Constant" Type="Folder">
				<Item Name="Type ID Constant.xnode" Type="XNode" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Type ID Constant/Type ID Constant.xnode"/>
			</Item>
			<Item Name="Easy XML Editor Menu.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Easy XML Editor Menu.vi"/>
			<Item Name="Easy XML Editor.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Easy XML Editor.vi"/>
			<Item Name="Find Block Diagram Resource.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Find Block Diagram Resource.vi"/>
			<Item Name="Find Resource by Type (I32).vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Find Resource by Type (I32).vi"/>
			<Item Name="Find Resource by Type (String).vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Find Resource by Type (String).vi"/>
			<Item Name="Find Resource by Type.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Find Resource by Type.vi"/>
			<Item Name="Fix BDPW Checksum.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Fix BDPW Checksum.vi"/>
			...
			<Item Name="Resource Editor.vi" Type="VI" URL="/&lt;resource&gt;/dialog/QuickDrop/plugins/PaneRelief/Low-Level VI Manipulation/Resource Editor.vi"/>
